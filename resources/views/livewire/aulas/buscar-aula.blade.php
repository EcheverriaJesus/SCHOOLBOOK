<div class="block w-full md:w-1/3">
    <form>   
        <label for="default-search" class="mb-2 text-base font-medium text-gray-700">Buscar Aula</label>
        <div class="relative">
            ...
            <input wire:model='searchClassroom' type="search" id="default-search" class="block w-full p-3 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Buscar por nombre" required>
        </div>
    </form>
</div>
