...
<div class="flex flex-col items-stretch gap-3 mt-5 md:mt-0 md:flex-row">
    ...
    {{-- Boton eliminar --}}
    <form wire:submit.prevent="deleteNotice({{$notice->id}})">
        @csrf
        <button type="submit" class="flex justify-center gap-2 px-4 py-2 text-xs font-bold text-white uppercase bg-red-600 rounded-lg"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            stroke="currentColor" class="w-6 h-6">
            <path stroke-linecap="round" stroke-linejoin="round"
