<x-app-layout>
    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <section class="w-auto w-full h-auto p-6 mb-10 space-y-6 bg-white border shadow-2xl sm:bg-white rounded-xl">
                <x-button_back>
                ...
                <form class="flex flex-col items-center" method="POST" action="{{ route('user.update', $user) }}">
                    ...
                    <ul
                        class="w-48 mt-3 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    ...
                    <div class="flex justify-center mt-10">
                        <button
                            class="items-center px-4 py-2 font-semibold tracking-widest text-white transition duration-150 ease-in-out bg-blue-700 border rounded-md tet-sm border-transparet hover:bg-blue-600"
