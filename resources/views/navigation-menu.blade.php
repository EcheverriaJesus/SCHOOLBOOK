    ...
    <nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                ...
                <h1 class="justify-start hidden text-2xl font-semibold text-black sm:flex flotar">Bienvenido a SCHOOLBOOK
                </h1>
            ...
            <ul class="space-y-2">
                ...
                <li @class(['bg-amber-300 rounded-lg' => request()->routeIs('courses.index', 'courses.create', 'courses.edit', 'courses.show')])>
                    ...
                    @class([
                        'flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white' => true,
                        'hover:bg-amber-300 dark:hover:bg-gray-700' => !request()->routeIs('classroom.index'),
                        'bg-amber-300' => request()->routeIs('courses.index', 'courses.create', 'courses.edit', 'courses.show')
                    ])
                    >
                    <svg stroke="#284CDA" width="32" height="32" fill="none" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
