    ...
    <aside id="logo-sidebar"
        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
            <ul class="space-y-2">
                ...
                <li @class(['bg-amber-300 rounded-lg'=> request()->routeIs('students.index', 'students.create',
                    'students.edit', 'students.show')])>
                ...
                <li @class(['bg-amber-300 rounded-lg'=> request()->routeIs('teachers.index', 'teachers.create',
                    'teachers.edit', 'teachers.show')])>
                ...
                <li @class(['bg-amber-300 rounded-lg'=> request()->routeIs('contributions.index',
                    'contributions.create', 'contributions.edit', 'contributions.show')])>
                ...
                <li @class(['bg-amber-300 rounded-lg'=> request()->routeIs('courses.index', 'courses.create',
                    'courses.edit', 'courses.show')])>
