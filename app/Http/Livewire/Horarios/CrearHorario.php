...
class CrearHorario extends Component
{
    ...
    public function crearHorario()
    {
        $rules = [
            ...
            'grupo' => 'required|exists:groups,id',
        ];
    ...
    public function render()
    {
        ...
        $courses = Course::whereHas('groupCourses', function ($query) use ($grupoId) {
        ...
        //dd($coursesSchedule);
        return view('livewire.horarios.crear-horario', [
            'groups' => $groups,
            'courses' => $courses,
